...
public class CalendarMain extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../res/calendar/CalendarIndividual.fxml"));
		Scene scene = new Scene((BorderPane)fxmlLoader.load(),700,600);	
		cController = fxmlLoader.getController();
		scene.getStylesheets().add(getClass().getResource("../res/calendar/Calendar.css").toExternalForm());
